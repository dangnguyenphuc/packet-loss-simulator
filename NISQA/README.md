...
To install requirements install [pyenv](https://github.com/pyenv/pyenv) and then use:
...
This will create a new environment with the name "venv". Activate this environment to go on:
